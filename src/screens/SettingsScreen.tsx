    ...
    const handleEnableAccessibility = () => {
        Alert.alert(
            ...
            [
                ...
                { text: 'Open Settings', onPress: () => mockAccessibilityService.requestAccessibilityPermission() },
            ]
        );
    };
            ...
            <View style={styles.section}>
                ...
                <View style={styles.settingRow}>
                    ...
                    <Switch
                        ...
                        onValueChange={(val) => handleToggleSetting('floatingBubbleEnabled', val)}
                ...
                <View style={styles.settingRow}>
                    ...
                    <Switch
                        ...
                        onValueChange={(val) => handleToggleSetting('pushNotificationsEnabled', val)}
                        trackColor={{ false: '#e0e0e0', true: '#2196F3' }}
                    />
                </View>
                ...
                <View style={styles.settingRow}>
                    ...
                    <Switch
                        ...
                        onValueChange={(val) => handleToggleSetting('vibrationEnabled', val)}
                        trackColor={{ false: '#e0e0e0', true: '#2196F3' }}
                    />
                </View>
